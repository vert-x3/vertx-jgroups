...
import io.vertx.spi.cluster.jgroups.domain.MultiMap;
import io.vertx.spi.cluster.jgroups.domain.SyncMapWrapper;
import io.vertx.spi.cluster.jgroups.domain.async.AsyncMapWrapper;
import io.vertx.spi.cluster.jgroups.domain.async.AsyncMultiMapWrapper;
import io.vertx.spi.cluster.jgroups.support.LambdaLogger;
import io.vertx.spi.cluster.jgroups.services.*;
