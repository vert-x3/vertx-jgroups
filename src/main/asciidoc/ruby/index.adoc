...
----
compile 'io.vertx:vertx-jgroups:3.5.0-SNAPSHOT'
----


If you are using Vert.x from the command line, the jar corresponding to this cluster manager (it will be named
`vertx-jgroups-3.5.0-SNAPSHOT.jar` should be in the `lib` directory of the Vert.x installation. Don't forget to
